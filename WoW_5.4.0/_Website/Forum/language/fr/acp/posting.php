...
$lang = array_merge($lang, array(
	...
	'tokens'	=>	array(
		...
		'URL'			=> 'Un lien correct utilisant n’importe quel protocole (http, ftp, etc.) ne pouvant pas être utilisé pour des injections de Javascript. Si aucun protocole n’est fourni, « http:// » sera utilisé par défaut.',
		'LOCAL_URL'		=> 'Un lien local. Le lien doit être relatif à la page du sujet et ne doit pas contenir de nom de serveur ou de protocole.',
