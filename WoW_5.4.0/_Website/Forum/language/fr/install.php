...
$lang = array_merge($lang, array(
	...
	'NO_UPDATE_FILES_OUTDATED'		=> 'Aucun répertoire de mise à jour correct n’a été trouvé, veuillez vous assurer d’avoir correctement transféré les fichiers nécessaires.<br /><br />Votre installation ne semble <strong>pas</strong> à jour. Des mises à jour sont disponibles pour votre version de phpBB %1$s, veuillez vous rendre sur <a href="http://www.phpbb.com/downloads/" rel="external">la page des téléchargements du site officiel</a> ou sur <a href="http://www.phpbb.fr/" rel="external">la communauté de support francophone</a> afin d’obtenir une archive de mise à jour de votre version %2$s vers la version %3$s.',
